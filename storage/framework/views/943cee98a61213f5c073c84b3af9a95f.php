                    ...
                    <div class="collapse" id="sidebarTicketingOps">
                        <ul class="nav sub-navbar-nav">
                            <?php if($canViewTicketOps): ?>
                                <li class="sub-nav-item"><a class="sub-nav-link" href="<?php echo e(route('tickets.index')); ?>"><?php echo e($user?->role === 'requester' ? 'My Tickets' : 'Ticket List'); ?></a></li>
                            <?php endif; ?>
                            <?php if($canApproveTicketOps): ?>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link d-flex justify-content-between align-items-center gap-2" href="<?php echo e(route('tickets.index', ['approval_queue' => 'my'])); ?>">
                                        <span>Needs Approval</span>
                                        <?php if($needsApprovalCount > 0): ?>
                                            <span class="badge bg-danger-subtle text-danger"><?php echo e(number_format($needsApprovalCount)); ?></span>
                                        <?php else: ?>
