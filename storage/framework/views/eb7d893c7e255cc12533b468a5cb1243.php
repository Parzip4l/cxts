...
<?php echo $__env->make('layouts.partials.page-title', ['title' => 'Help Center', 'subtitle' => 'Manual Guide'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div class="manual-guide-page">
        ...
        <div class="card-body">
            <div class="d-flex flex-column flex-lg-row justify-content-between gap-4">
                <div class="d-flex gap-3">
                    ...
                    <div>
                        <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                            ...
                            <span class="badge bg-light text-dark border"><?php echo e(count($sections)); ?> sections</span>
                            <?php if($lastUpdated): ?>
                                <span class="badge bg-light text-dark border">Updated <?php echo e($lastUpdated->format('d M Y H:i')); ?></span>
                            <?php endif; ?>
                        </div>
                ...
                <div class="align-self-lg-end">
                    <span class="badge bg-light text-dark border">Source: <?php echo e($sourceName); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-lg-5">
                    <div class="d-flex flex-wrap justify-content-lg-end gap-2">
                        <?php if($hasStatusSummary): ?>
                            <span class="badge bg-success-subtle text-success">Implemented: <?php echo e($statusSummary['Implemented']); ?></span>
                            <span class="badge bg-warning-subtle text-warning">Partial: <?php echo e($statusSummary['Partial']); ?></span>
                            <span class="badge bg-info-subtle text-info">Ongoing: <?php echo e($statusSummary['Ongoing']); ?></span>
                        <?php else: ?>
            ...
            <p class="text-muted small mb-0 mt-3" id="manualGuideSearchCount"><?php echo e(count($sections)); ?> sections shown</p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="manual-toc-list d-flex flex-column gap-1">
                        <?php $__currentLoopData = $tableOfContents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a
                                href="#<?php echo e($item['slug']); ?>"
                                class="manual-toc-link manual-toc-level-<?php echo e($item['level']); ?> text-decoration-none d-flex justify-content-between align-items-center gap-2"
                                data-manual-toc="<?php echo e($item['slug']); ?>">
                                <span><?php echo e($item['title']); ?></span>
                                <?php if($item['status']): ?>
                                    <span class="badge bg-<?php echo e($item['status']['class']); ?>-subtle text-<?php echo e($item['status']['class']); ?>"><?php echo e($item['status']['label']); ?></span>
                                <?php endif; ?>
                            </a>
            ...
            <div class="d-flex flex-column gap-4">
                <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <section
                        ...
                        data-manual-section="<?php echo e($section['slug']); ?>">
                        <div class="card-header bg-transparent border-0 pb-0">
                            <div class="d-flex justify-content-between align-items-start gap-3 flex-wrap">
                                <div>
                                    <div class="text-muted small text-uppercase fw-semibold mb-1">Section <?php echo e($loop->iteration); ?></div>
                                    <h5 class="mb-0"><?php echo e($section['title']); ?></h5>
                                </div>
                                <?php if($section['status']): ?>
                                    <span class="badge bg-<?php echo e($section['status']['class']); ?>-subtle text-<?php echo e($section['status']['class']); ?>">
                                        <?php echo e($section['status']['label']); ?>
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => 'Manual Guide'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhamadsobirin/Documents/cxts/resources/views/modules/manual-guide/index.blade.php ENDPATH**/ ?>