...
unset($__errorArgs, $__bag); ?>"
                    value="<?php echo e(old('code', $service->code)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <input type="text" id="service_category" name="service_category"
                    class="form-control <?php $__errorArgs = ['service_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                    value="<?php echo e(old('service_category', $service->service_category)); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <select id="ownership_model" name="ownership_model"
                    class="form-select <?php $__errorArgs = ['ownership_model'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                    <?php $__currentLoopData = $ownershipOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ownershipOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($ownershipOption); ?>" <?php if(old('ownership_model', $service->ownership_model ?: 'internal') === $ownershipOption): echo 'selected'; endif; ?>>
                            <?php echo e(ucfirst($ownershipOption)); ?>

                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php $__errorArgs = ['ownership_model'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <select id="service_manager_user_id" name="service_manager_user_id"
                    ...
                    class="form-select <?php $__errorArgs = ['service_manager_user_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = $managerOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($option->id); ?>" <?php if((string) old('service_manager_user_id', $service->service_manager_user_id) === (string) $option->id): echo 'selected'; endif; ?>>
                            <?php echo e($option->name); ?>

                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php $__errorArgs = ['service_manager_user_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <select id="department_owner_id" name="department_owner_id"
                    ...
                    class="form-select <?php $__errorArgs = ['department_owner_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = $departmentOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($option->id); ?>" <?php if((string) old('department_owner_id', $service->department_owner_id) === (string) $option->id): echo 'selected'; endif; ?>>
                            <?php echo e($option->name); ?>
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <?php $__currentLoopData = $vendorOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($option->id); ?>" <?php if((string) old('vendor_id', $service->vendor_id) === (string) $option->id): echo 'selected'; endif; ?>>
                            <?php echo e($option->name); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                        <?php if((bool) old('is_active', $service->is_active ?? true)): echo 'checked'; endif; ?>>
            ...
            <div class="col-12 d-flex gap-2">
                ...
                <a href="<?php echo e(route('master-data.services.index')); ?>" class="btn btn-outline-light">Cancel</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => $pageTitle], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhamadsobirin/Documents/cxts/resources/views/modules/master-data/services/form.blade.php ENDPATH**/ ?>