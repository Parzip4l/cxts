...
unset($__errorArgs, $__bag); ?>"
                    value="<?php echo e(old('code', $assetCategory->code)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                    value="<?php echo e(old('name', $assetCategory->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $assetCategory->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                        <?php if((bool) old('is_active', $assetCategory->is_active ?? true)): echo 'checked'; endif; ?>>
            ...
            <div class="col-12 d-flex gap-2">
                ...
                <a href="<?php echo e(route('master-data.asset-categories.index')); ?>" class="btn btn-outline-light">Cancel</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => $pageTitle], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhamadsobirin/Documents/cxts/resources/views/modules/master-data/asset-categories/form.blade.php ENDPATH**/ ?>