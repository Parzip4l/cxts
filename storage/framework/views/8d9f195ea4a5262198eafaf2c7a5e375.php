...
<div
    ...
    data-endpoint="<?php echo e(route('assistant.respond')); ?>"
    data-role="<?php echo e(auth()->user()?->role); ?>"
    data-suggestions='<?php echo json_encode($assistantSuggestions, 15, 512) ?>'
>
    ...
    <div class="cxts-assistant__panel" hidden>
        ...
        <div class="cxts-assistant__suggestions" data-assistant-suggestions>
            <?php $__currentLoopData = $assistantSuggestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suggestion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button type="button" class="cxts-assistant__chip" data-assistant-suggestion="<?php echo e($suggestion); ?>"><?php echo e($suggestion); ?></button>
...
<?php /**PATH /Users/muhamadsobirin/Documents/cxts/resources/views/layouts/partials/floating-assistant.blade.php ENDPATH**/ ?>