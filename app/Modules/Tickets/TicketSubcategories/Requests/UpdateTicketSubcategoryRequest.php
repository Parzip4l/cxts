...
class UpdateTicketSubcategoryRequest extends FormRequest
{
    ...
    {
        $ticketSubcategoryId = (int) ($this->route('ticketSubcategory')?->id ?? $this->route('ticket_subcategory')?->id);
