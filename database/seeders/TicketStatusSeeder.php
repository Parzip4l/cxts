...
class TicketStatusSeeder extends Seeder
{
    public function run(): void
    {
        $statuses = [
            ...
            ['code' => 'PENDING_CUSTOMER', 'name' => 'Pending Customer', 'is_open' => true, 'is_in_progress' => false, 'is_closed' => false],
            ...
            ['code' => 'CANCELLED', 'name' => 'Cancelled', 'is_open' => false, 'is_in_progress' => false, 'is_closed' => true],
        ];
