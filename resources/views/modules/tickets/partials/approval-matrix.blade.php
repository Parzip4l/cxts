    ...
    <div class="d-flex flex-wrap justify-content-between gap-2 align-items-start mb-3">
        <div>
            ...
            <div class="small text-muted">
                {{ $scopeLabel }} bisa menentukan apakah ticket perlu approval, boleh direct assign, dan siapa approver yang dipakai.
                {{ $inheritLabel ? 'Kosongkan override agar mengikuti ' . $inheritLabel . '.' : '' }}
            </div>
        </div>
        <span class="badge bg-primary-subtle text-primary">{{ $scopeLabel }}</span>
    </div>
