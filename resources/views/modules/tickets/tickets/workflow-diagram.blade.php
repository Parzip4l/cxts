@extends('layouts.vertical', ['subtitle' => 'Ticket Workflow Diagram'])

@section('content')
    @include('layouts.partials.page-title', ['title' => 'Ticketing', 'subtitle' => 'Enterprise Workflow Diagram'])
                ...
                <div class="card-body p-4 p-xl-5">
                    <div class="d-flex justify-content-between align-items-start gap-3 flex-wrap mb-4">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            <a href="{{ asset('images/diagrams/enterprise-ticketing-workflow.svg') }}" target="_blank" rel="noopener" class="btn btn-outline-secondary">
                                Open SVG
                            </a>
                            <a href="{{ asset('images/diagrams/enterprise-ticketing-workflow.svg') }}" download="enterprise-ticketing-workflow.svg" class="btn btn-primary">
                                Download SVG
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="workflow-diagram-frame">
                        <img
                            src="{{ asset('images/diagrams/enterprise-ticketing-workflow.svg') }}"
