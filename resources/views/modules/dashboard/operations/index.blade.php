                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-start mb-4">
                        <div>
                            ...
                            <h3 class="mb-1">{{ number_format($ticketSummary['total_tickets']) }}</h3>
                            <div class="small text-muted">Open queue: {{ number_format($ticketSummary['open_tickets']) }}</div>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <span class="small text-muted">{{ $ticketSummary['total_tickets'] > 0 ? number_format(($ticketSummary['open_tickets'] / max(1, $ticketSummary['total_tickets'])) * 100, 0) : 0 }}% open</span>
                    </div>
                    <div class="progress bg-light" style="height: 10px;">
                        <div class="progress-bar bg-primary" style="width: {{ $ticketSummary['total_tickets'] > 0 ? min(100, ($ticketSummary['open_tickets'] / max(1, $ticketSummary['total_tickets'])) * 100) : 0 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-start mb-4">
                        <div>
                            ...
                            <h3 class="mb-1">{{ number_format($responseCompliance, 2) }}%</h3>
                            <div class="small text-muted">Breached: {{ number_format($slaSummary['response']['breached']) }}</div>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="badge {{ $responseTone['badge'] }}">{{ $responseTone['label'] }}</span>
                        <span class="small text-muted">Target monitor</span>
                    </div>
                    <div class="progress bg-light" style="height: 10px;">
                        <div class="progress-bar {{ $responseTone['bar'] }}" style="width: {{ max(0, min(100, $responseCompliance)) }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-start mb-4">
                        <div>
                            ...
                            <h3 class="mb-1">{{ number_format($resolutionCompliance, 2) }}%</h3>
                            <div class="small text-muted">Breached: {{ number_format($slaSummary['resolution']['breached']) }}</div>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="badge {{ $resolutionTone['badge'] }}">{{ $resolutionTone['label'] }}</span>
                        <span class="small text-muted">Execution health</span>
                    </div>
                    <div class="progress bg-light" style="height: 10px;">
                        <div class="progress-bar {{ $resolutionTone['bar'] }}" style="width: {{ max(0, min(100, $resolutionCompliance)) }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-start mb-4">
                        <div>
                            ...
                            <h3 class="mb-1">{{ number_format($inspectionSummary['submitted_inspections']) }}</h3>
                            <div class="small text-muted">Normal findings: {{ number_format($inspectionSummary['normal_inspections']) }}</div>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <span class="small text-muted">{{ number_format($inspectionNormalityRate, 0) }}%</span>
                    </div>
                    <div class="progress bg-light" style="height: 10px;">
                        <div class="progress-bar bg-primary" style="width: {{ max(0, min(100, $inspectionNormalityRate)) }}%"></div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                ...
                                <div class="d-flex align-items-end justify-content-between gap-2">
                                    <h4 class="mb-0">{{ number_format($totalCreatedInTrend) }}</h4>
                                    <span class="badge bg-primary-subtle text-primary">Demand</span>
                                </div>
                                <div class="small text-muted mt-2">Rata-rata {{ number_format($avgDemandPerDay, 1) }} ticket per hari.</div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                ...
                                <div class="d-flex align-items-end justify-content-between gap-2">
                                    <h4 class="mb-0">{{ number_format($totalCompletedInTrend) }}</h4>
                                    <span class="badge bg-success-subtle text-success">Closure</span>
                                </div>
                                <div class="small text-muted mt-2">Coverage {{ number_format($closureCoverage, 1) }}% dari demand masuk.</div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                ...
                                <div class="d-flex align-items-end justify-content-between gap-2">
                                    <h4 class="mb-0">{{ number_format((int) ($peakDemand['created'] ?? 0)) }}</h4>
                                    <span class="badge bg-warning-subtle text-warning">Peak</span>
                                </div>
                                <div class="small text-muted mt-2">
                                    {{ isset($peakDemand['date']) ? \Illuminate\Support\Carbon::parse($peakDemand['date'])->translatedFormat('d M Y') : 'Belum ada data' }}
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                ...
                                <div class="d-flex align-items-end justify-content-between gap-2">
                                    <h4 class="mb-0">{{ number_format($backlogPressure) }}</h4>
                                    <span class="badge {{ $backlogPressure > 8 ? 'bg-danger-subtle text-danger' : ($backlogPressure > 3 ? 'bg-warning-subtle text-warning' : 'bg-success-subtle text-success') }}">
                                        {{ $backlogPressure > 8 ? 'High' : ($backlogPressure > 3 ? 'Watch' : 'Stable') }}
                                    </span>
                                </div>
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                ...
                                <h4 class="mb-2">{{ number_format($responseCompliance, 2) }}%</h4>
                                <div class="progress bg-light mb-2" style="height: 8px;">
                                    <div class="progress-bar {{ $responseTone['bar'] }}" style="width: {{ max(0, min(100, $responseCompliance)) }}%"></div>
                                </div>
                                <div class="small text-muted">Breached {{ number_format($slaSummary['response']['breached']) }} ticket pada periode aktif.</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                ...
                                <h4 class="mb-2">{{ number_format($resolutionCompliance, 2) }}%</h4>
                                <div class="progress bg-light mb-2" style="height: 8px;">
                                    <div class="progress-bar {{ $resolutionTone['bar'] }}" style="width: {{ max(0, min(100, $resolutionCompliance)) }}%"></div>
                                </div>
                                <div class="small text-muted">Overdue {{ number_format($ticketSummary['overdue_resolution_tickets']) }} ticket butuh recovery plan.</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                <div class="text-muted text-uppercase fw-semibold small mb-2">Inspection Watch</div>
                                <h4 class="mb-1">{{ number_format($inspectionSummary['abnormal_inspections']) }}</h4>
                                <div class="small text-muted">Temuan abnormal dari {{ number_format($inspectionSummary['submitted_inspections']) }} inspection submitted.</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                <div class="text-muted text-uppercase fw-semibold small mb-2">Unassigned Queue</div>
                                <h4 class="mb-1">{{ number_format($ticketSummary['unassigned_tickets']) }}</h4>
        ...
        <div class="col-xl-7">
            <div class="card border-0 shadow-sm dashboard-section-card">
                <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center dashboard-section-header">
                    ...
                    <span class="badge bg-white text-dark border">{{ $taxonomyHotspots->count() }} hotspots</span>
                </div>
                <div class="card-body pt-3">
                        ...
                        <div class="col-lg-8">
                            <div class="table-responsive dashboard-table-shell">
                                <table class="table align-middle mb-0">
                                    ...
                                    <tbody>
                                        @forelse ($taxonomyHotspots as $row)
                                            <tr>
                                                <td>
                                                    <div class="fw-medium">{{ $row['ticket_sub_category_name'] }}</div>
                                                    <div class="small text-muted">{{ $row['ticket_type_name'] }} / {{ $row['ticket_category_name'] }}</div>
                                                </td>
                            ...
                            <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                ...
                                <div class="vstack gap-2">
                                    @foreach ($statusDistribution as $status)
                                        <div class="dashboard-chip-stat rounded-3 px-3 py-2 d-flex justify-content-between align-items-center">
                                            <span class="small fw-medium">{{ $status['status_name'] }}</span>
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    @foreach ($priorityDistribution as $priority)
                                        <span class="badge bg-primary-subtle text-primary">{{ $priority['priority_name'] }}: {{ number_format($priority['total_tickets']) }}</span>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                ...
                <div class="row g-3">
                                ...
                                @if ($topEngineer)
                                    <div class="dashboard-mini-panel rounded-3 p-3 mb-3">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start gap-3">
                                            <div>
                                                <h5 class="mb-1">{{ $topEngineer['engineer_name'] }}</h5>
                                                <div class="small text-muted">{{ $topEngineer['department_name'] }}</div>
                                            </div>
                                            <span class="badge bg-primary-subtle text-primary">{{ number_format($topEngineer['effectiveness_score'], 1) }}</span>
                                        </div>
                                    </div>
                                @endif
                    ...
                    <div class="col-12">
                        <div class="card border-0 shadow-sm dashboard-section-card">
                            ...
                            <div class="card-body pt-3">
                                <div class="vstack gap-2">
                                    @forelse ($criticalAlerts->take(4) as $ticket)
                                        <div class="dashboard-alert-card rounded-3 p-3">
                                            <div class="d-flex justify-content-between align-items-start gap-3">
                                                <div class="pe-2">
                                                    <div class="fw-medium mb-1">{{ $ticket['ticket_number'] }}</div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                        ...
                                        <h4 class="mb-0">{{ number_format($myPerformance['engineer']['assigned_tickets']) }}</h4>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                        <p class="text-muted mb-1">Completed</p>
                                        <h4 class="mb-0">{{ number_format($myPerformance['engineer']['completed_tickets']) }}</h4>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                        <p class="text-muted mb-1">Resolution SLA</p>
                                        <h4 class="mb-0">{{ number_format($myPerformance['engineer']['resolution_compliance_rate'], 2) }}%</h4>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="dashboard-mini-panel rounded-3 p-3 h-100">
                                        <p class="text-muted mb-1">Effectiveness Score</p>
                                        <h4 class="mb-0">{{ number_format($myPerformance['engineer']['effectiveness_score'], 2) }}</h4>
                                    </div>
                                </div>
                            </div>
                        @else
