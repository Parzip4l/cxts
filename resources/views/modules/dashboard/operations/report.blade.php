        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    ...
                    <div class="text-muted small">{{ $reportPeriodLabel }}</div>
                </div>
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ $exportUrl }}" class="btn btn-outline-primary text-nowrap">
                    ...
                    <a href="mailto:?subject={{ rawurlencode($mailSubject) }}&body={{ rawurlencode($mailBody) }}" class="btn btn-outline-secondary text-nowrap">
            ...
            <textarea class="visually-hidden" data-report-summary>{{ $handoverLines }}</textarea>
        </div>
    </div>
